...
> 官方文档：[获取短剧变现类型](https://developers.weixin.qq.com/miniprogram/dev/server/API/dramaOthersAPI/api_developergetiaadrama.html)
...
```bash
POST https://api.weixin.qq.com/wxadrama/developergetiaadrama?access_token=ACCESS_TOKEN
```
