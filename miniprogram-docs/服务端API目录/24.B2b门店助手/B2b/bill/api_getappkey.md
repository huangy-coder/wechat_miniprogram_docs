...
> 官方文档：[获取密钥AppKey](https://developers.weixin.qq.com/miniprogram/dev/server/API/B2b/bill/api_getappkey.html)
> 所属分类：[B2b门店助手](../../B2b门店助手目录.md)
> 导航路径：B2b门店助手 / B2b支付 / 获取密钥AppKey
> 整理日期：2026-06-01
...
```bash
POST https://api.weixin.qq.com/retail/B2b/getappkey?access_token=ACCESS_TOKEN
```
