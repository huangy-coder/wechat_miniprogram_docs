...
> 官方文档：[插件申请管理](https://developers.weixin.qq.com/miniprogram/dev/server/API/plugin-management/api_managepluginapplication.html)
> 所属分类：[插件管理](../插件管理目录.md)
> 导航路径：插件管理 / 插件申请管理
> 整理日期：2026-06-01
...
### Res.apply_list(Array).categories Object Payload
