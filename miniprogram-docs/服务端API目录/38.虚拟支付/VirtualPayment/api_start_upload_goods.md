...
> 官方文档：[批量上传道具](https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_start_upload_goods.html)
> 所属分类：[虚拟支付](../虚拟支付目录.md)
> 导航路径：虚拟支付 / 批量上传道具
> 整理日期：2026-06-01
...
```bash
POST https://api.weixin.qq.com/xpay/start_upload_goods?access_token=ACCESS_TOKEN&pay_sig=PAY_SIG
```
