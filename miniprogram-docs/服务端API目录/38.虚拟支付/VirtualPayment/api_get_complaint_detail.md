...
> 官方文档：[获取投诉详情](https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_get_complaint_detail.html)
> 所属分类：[虚拟支付](../虚拟支付目录.md)
> 导航路径：虚拟支付 / 获取投诉详情
> 整理日期：2026-06-01
...
```bash
POST https://api.weixin.qq.com/xpay/get_complaint_detail?access_token=ACCESS_TOKEN&pay_sig=PAY_SIG
```
