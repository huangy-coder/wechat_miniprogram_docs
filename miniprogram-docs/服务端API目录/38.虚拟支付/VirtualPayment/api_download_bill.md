...
> 官方文档：[下载小程序账单](https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_download_bill.html)
> 所属分类：[虚拟支付](../虚拟支付目录.md)
> 导航路径：虚拟支付 / 下载小程序账单
> 整理日期：2026-06-01
...
```bash
POST https://api.weixin.qq.com/xpay/download_bill?access_token=ACCESS_TOKEN&pay_sig=PAY_SIG
```
