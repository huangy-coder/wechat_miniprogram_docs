...
> 官方文档：[获取直播间分享二维码](https://developers.weixin.qq.com/miniprogram/dev/server/API/livebroadcast/studio-management/api_getsharedcode.html)
> 所属分类：[小程序直播](../../小程序直播目录.md)
> 导航路径：小程序直播 / 直播间管理 / 获取直播间分享二维码
> 整理日期：2026-06-01
