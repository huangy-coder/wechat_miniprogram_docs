...
> 官方文档：[logistics.onAddOrder](https://developers.weixin.qq.com/miniprogram/dev/server/event_push/express/provider/Request_an_order_event.html)
> 所属分类：[事件通知](../../事件通知目录.md)
> 导航路径：事件通知 / 物流助手 / 运力方使用 / 请求下单事件
> 整理日期：2026-06-01
...
| Token | string | 订单 Token。请保存该 Token，调用[更新运单轨迹](https://developers.weixin.qq.com/miniprogram/dev/server/API/express/express-by-provider/api_updatepath)时需要传入 |
