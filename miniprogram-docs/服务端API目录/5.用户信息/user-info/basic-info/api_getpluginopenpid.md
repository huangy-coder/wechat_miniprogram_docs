...
> 官方文档：[获取插件用户openpid](https://developers.weixin.qq.com/miniprogram/dev/server/API/user-info/basic-info/api_getpluginopenpid.html)
> 所属分类：[用户信息](../../用户信息目录.md)
> 导航路径：用户信息 / 用户信息 / 获取插件用户openpid
> 整理日期：2026-06-01
