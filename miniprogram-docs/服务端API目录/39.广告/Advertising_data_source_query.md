...
> 官方文档：[广告数据源查询（ad.getUserActionSets）](https://developers.weixin.qq.com/miniprogram/dev/server/ad/Advertising_data_source_query.html)
> 所属分类：[广告](广告目录.md)
> 导航路径：广告 / 广告数据源查询
> 整理日期：2026-06-01
...
```bash
https://api.weixin.qq.com/marketing/user_action_sets/get
```
...
```js
cloud.openapi.ad.getUserActionSets({
  xxx: '字符串',
  yyy: 100,
})
```
