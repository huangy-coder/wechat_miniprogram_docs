...
> 官方文档：[回传广告数据（ad.addUserAction）](https://developers.weixin.qq.com/miniprogram/dev/server/ad/Return_advertising_data.html)
> 所属分类：[广告](广告目录.md)
> 导航路径：广告
> 整理日期：2026-06-01
...
```bash
POST  https://api.weixin.qq.com/marketing/user_actions/add
```
