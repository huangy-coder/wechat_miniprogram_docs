...
> 官方文档：[广告创建数据源（ad.addUserActionSet）](https://developers.weixin.qq.com/miniprogram/dev/server/ad/Advertisement_creation_data_source.html)
> 所属分类：[广告](广告目录.md)
> 导航路径：广告 / 广告创建数据源
> 整理日期：2026-06-01
...
```bash
https://api.weixin.qq.com/marketing/user_action_sets/add
```
...
```js
cloud.openapi.ad.addUserActionSet({
  xxx: '字符串',
  yyy: 100,
})
```
