...
> 官方文档：[查询版权授权信息](https://developers.weixin.qq.com/miniprogram/dev/server/API/minidrama/authorizecopyright/api_getcopyrightauthorizationlist.html)
> 所属分类：[短剧媒资管理](../../短剧媒资管理目录.md)
> 导航路径：短剧媒资管理 / 版权授权 / 查询版权授权信息
> 整理日期：2026-06-01
