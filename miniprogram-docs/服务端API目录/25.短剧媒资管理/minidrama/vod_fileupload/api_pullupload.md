...
> 官方文档：[拉取上传](https://developers.weixin.qq.com/miniprogram/dev/server/API/minidrama/vod_fileupload/api_pullupload.html)
> 所属分类：[短剧媒资管理](../../短剧媒资管理目录.md)
> 导航路径：短剧媒资管理 / 媒资上传 / 拉取上传
> 整理日期：2026-06-01
...
3. 该接口为异步接口，上传完成会推送上传完成事件到开发者服务器，开发者也可以调用"[查询任务](https://developers.weixin.qq.com/miniprogram/dev/server/API/minidrama/vod_fileupload/api_gettask)"接口来轮询上传结果。
