...
> 官方文档：[更新物流信息](https://developers.weixin.qq.com/miniprogram/dev/server/API/weixin-express/express-search/api_update_waybill_goods.html)
> 所属分类：[微信物流服务](../../微信物流服务目录.md)
> 导航路径：微信物流服务 / 查询组件 / 更新物流信息
> 整理日期：2026-06-01
...
```bash
POST https://api.weixin.qq.com/cgi-bin/express/delivery/open_msg/update_waybill_goods?access_token=ACCESS_TOKEN
```
