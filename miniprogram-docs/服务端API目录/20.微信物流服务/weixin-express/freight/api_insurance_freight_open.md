...
> 官方文档：[开通无忧退货](https://developers.weixin.qq.com/miniprogram/dev/server/API/weixin-express/freight/api_insurance_freight_open.html)
...
```bash
GET https://api.weixin.qq.com/wxa/business/insurance_freight/open?access_token=ACCESS_TOKEN
```
