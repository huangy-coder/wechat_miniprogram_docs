...
> 官方文档：[获取用户访问小程序数据周趋势](https://developers.weixin.qq.com/miniprogram/dev/server/API/data-analysis/visit-trend/api_getweeklyvisittrend.html)
> 所属分类：[数据分析](../../数据分析目录.md)
> 导航路径：数据分析 / 访问趋势 / 获取用户访问小程序数据周趋势
> 整理日期：2026-06-01
