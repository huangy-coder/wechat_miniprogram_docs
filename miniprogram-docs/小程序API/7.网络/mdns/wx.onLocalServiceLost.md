...
> 官方文档：[wx.onLocalServiceLost(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/network/mdns/wx.onLocalServiceLost.html)
> 所属分类：[网络](../网络目录.md)
> 导航路径：网络 / mDNS / wx.onLocalServiceLost
> 整理日期：2026-06-01
