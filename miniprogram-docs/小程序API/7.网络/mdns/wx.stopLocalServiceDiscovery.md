...
> 官方文档：[wx.stopLocalServiceDiscovery(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/network/mdns/wx.stopLocalServiceDiscovery.html)
> 所属分类：[网络](../网络目录.md)
> 导航路径：网络 / mDNS / wx.stopLocalServiceDiscovery
> 整理日期：2026-06-01
