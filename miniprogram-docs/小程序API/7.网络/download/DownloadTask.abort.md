...
> 官方文档：[DownloadTask.abort()](https://developers.weixin.qq.com/miniprogram/dev/api/network/download/DownloadTask.abort.html)
> 所属分类：[网络](../网络目录.md)
> 导航路径：网络 / 下载 / DownloadTask / DownloadTask.abort
> 整理日期：2026-06-01
