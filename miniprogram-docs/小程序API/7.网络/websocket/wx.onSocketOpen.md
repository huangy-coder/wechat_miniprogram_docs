...
> 官方文档：[wx.onSocketOpen(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/network/websocket/wx.onSocketOpen.html)
> 所属分类：[网络](../网络目录.md)
> 导航路径：网络 / WebSocket / wx.onSocketOpen
> 整理日期：2026-06-01
