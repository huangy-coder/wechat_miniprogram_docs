...
> 官方文档：[wx.restartMiniProgram(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/navigate/wx.restartMiniProgram.html)
> 所属分类：[跳转](跳转目录.md)
> 导航路径：跳转 / wx.restartMiniProgram
> 整理日期：2026-06-01
