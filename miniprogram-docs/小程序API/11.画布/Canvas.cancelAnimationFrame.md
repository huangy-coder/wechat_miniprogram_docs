...
> 官方文档：[Canvas.cancelAnimationFrame(number requestID)](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/Canvas.cancelAnimationFrame.html)
> 所属分类：[画布](画布目录.md)
> 导航路径：画布 / Canvas / Canvas.cancelAnimationFrame
> 整理日期：2026-06-01
