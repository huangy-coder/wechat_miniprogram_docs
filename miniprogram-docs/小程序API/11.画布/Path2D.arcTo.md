...
> 官方文档：[Path2D.arcTo(number x1, number y1, number x2, number y2, number radius)](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/Path2D.arcTo.html)
> 所属分类：[画布](画布目录.md)
> 导航路径：画布 / Path2D / Path2D.arcTo
> 整理日期：2026-06-01
