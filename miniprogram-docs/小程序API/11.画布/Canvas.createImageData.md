...
> 官方文档：[ImageData Canvas.createImageData()](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/Canvas.createImageData.html)
> 所属分类：[画布](画布目录.md)
> 导航路径：画布 / Canvas / Canvas.createImageData
> 整理日期：2026-06-01
