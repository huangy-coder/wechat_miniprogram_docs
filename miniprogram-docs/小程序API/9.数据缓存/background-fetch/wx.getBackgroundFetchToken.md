...
> 官方文档：[wx.getBackgroundFetchToken(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/storage/background-fetch/wx.getBackgroundFetchToken.html)
> 所属分类：[数据缓存](../数据缓存目录.md)
> 导航路径：数据缓存 / 数据预拉取和周期性更新 / wx.getBackgroundFetchToken
> 整理日期：2026-06-01
