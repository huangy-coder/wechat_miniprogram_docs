...
> 官方文档：[Class: XRText](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRText.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRText
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRText

## Hierarchy

- [`Element`](Element.md) ↳ **`XRText`**

## Table of contents

### Constructors

- [constructor](XRText.md)

### Properties

- [dataMapping](XRText.md)
- [defaultComponents](XRText.md)
- [TYPE](XRText.md)
...
- [addChild](XRText.md)
- [addComponent](XRText.md)
- [dfs](XRText.md)
- [getChildAtIndex](XRText.md)
- [getChildByClass](XRText.md)
- [getChildByFilter](XRText.md)
- [getChildByName](XRText.md)
- [getChildrenByFilter](XRText.md)
- [getChildrenByName](XRText.md)
- [getComponent](XRText.md)
- [release](XRText.md)
- [removeChild](XRText.md)
- [removeComponent](XRText.md)
- [setAttribute](XRText.md)
- [setId](XRText.md)
