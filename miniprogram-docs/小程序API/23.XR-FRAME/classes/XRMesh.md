...
> 官方文档：[Class: XRMesh](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRMesh.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRMesh
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRMesh

标签为`xr-mesh`。

默认组件见[MeshDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#MeshDefaultComponents)，属性映射见[MeshDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#MeshDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRMesh`**

## Table of contents

### Constructors

- [constructor](XRMesh.md)

### Properties

- [dataMapping](XRMesh.md)
- [defaultComponents](XRMesh.md)
- [TYPE](XRMesh.md)
...
- [addChild](XRMesh.md)
- [addComponent](XRMesh.md)
- [dfs](XRMesh.md)
- [getChildAtIndex](XRMesh.md)
- [getChildByClass](XRMesh.md)
- [getChildByFilter](XRMesh.md)
- [getChildByName](XRMesh.md)
- [getChildrenByFilter](XRMesh.md)
- [getChildrenByName](XRMesh.md)
- [getComponent](XRMesh.md)
- [release](XRMesh.md)
- [removeChild](XRMesh.md)
- [removeComponent](XRMesh.md)
- [setAttribute](XRMesh.md)
- [setId](XRMesh.md)
