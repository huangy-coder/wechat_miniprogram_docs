...
> 官方文档：[Class: XRLight](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRLight.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRLight
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRLight

标签为`xr-ar-tracker`。

默认组件见[LightDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#LightDefaultComponents)，属性映射见[LightDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#LightDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRLight`**

## Table of contents

### Constructors

- [constructor](XRLight.md)

### Properties

- [dataMapping](XRLight.md)
- [defaultComponents](XRLight.md)
- [TYPE](XRLight.md)
...
- [addChild](XRLight.md)
- [addComponent](XRLight.md)
- [dfs](XRLight.md)
- [getChildAtIndex](XRLight.md)
- [getChildByClass](XRLight.md)
- [getChildByFilter](XRLight.md)
- [getChildByName](XRLight.md)
- [getChildrenByFilter](XRLight.md)
- [getChildrenByName](XRLight.md)
- [getComponent](XRLight.md)
- [release](XRLight.md)
- [removeChild](XRLight.md)
- [removeComponent](XRLight.md)
- [setAttribute](XRLight.md)
- [setId](XRLight.md)
...
• **new XRLight**(`_type`, `triggerEvent`)
