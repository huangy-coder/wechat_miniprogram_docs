...
> 官方文档：[Class: XRAssetRenderTexture](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRAssetRenderTexture.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRAssetRenderTexture
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRAssetRenderTexture

标签为`xr-asset-render-texture`。

默认组件见[AssetRenderTextureDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetRenderTextureDefaultComponents)，属性映射见[AssetRenderTextureDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetRenderTextureDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRAssetRenderTexture`**

## Table of contents

### Constructors

- [constructor](XRAssetRenderTexture.md)

### Properties

- [dataMapping](XRAssetRenderTexture.md)
- [defaultComponents](XRAssetRenderTexture.md)
- [TYPE](XRAssetRenderTexture.md)

### Accessors

- [event](XRAssetRenderTexture.md)
- [id](XRAssetRenderTexture.md)
- [inXML](XRAssetRenderTexture.md)
- [name](XRAssetRenderTexture.md)
- [parent](XRAssetRenderTexture.md)
- [scene](XRAssetRenderTexture.md)

### Methods

- [addChild](XRAssetRenderTexture.md)
- [addComponent](XRAssetRenderTexture.md)
- [dfs](XRAssetRenderTexture.md)
- [getChildAtIndex](XRAssetRenderTexture.md)
- [getChildByClass](XRAssetRenderTexture.md)
- [getChildByFilter](XRAssetRenderTexture.md)
- [getChildByName](XRAssetRenderTexture.md)
- [getChildrenByFilter](XRAssetRenderTexture.md)
- [getChildrenByName](XRAssetRenderTexture.md)
- [getComponent](XRAssetRenderTexture.md)
- [release](XRAssetRenderTexture.md)
- [removeChild](XRAssetRenderTexture.md)
- [removeComponent](XRAssetRenderTexture.md)
- [setAttribute](XRAssetRenderTexture.md)
- [setId](XRAssetRenderTexture.md)

## Constructors

### constructor

• **new XRAssetRenderTexture**(`_type`, `triggerEvent`)
