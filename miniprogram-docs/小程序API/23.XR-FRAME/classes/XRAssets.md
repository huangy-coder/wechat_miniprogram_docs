...
> 官方文档：[Class: XRAssets](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRAssets.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRAssets
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRAssets

标签为`xr-assets`。

默认组件见[AssetsDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetsDefaultComponents)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRAssets`**

## Table of contents

### Constructors

- [constructor](XRAssets.md)

### Properties

- [dataMapping](XRAssets.md)
- [defaultComponents](XRAssets.md)
- [neverTick](XRAssets.md)
- [TYPE](XRAssets.md)
...
- [addChild](XRAssets.md)
- [addComponent](XRAssets.md)
- [dfs](XRAssets.md)
- [getChildAtIndex](XRAssets.md)
- [getChildByClass](XRAssets.md)
- [getChildByFilter](XRAssets.md)
- [getChildByName](XRAssets.md)
- [getChildrenByFilter](XRAssets.md)
- [getChildrenByName](XRAssets.md)
- [getComponent](XRAssets.md)
- [release](XRAssets.md)
- [removeChild](XRAssets.md)
- [removeComponent](XRAssets.md)
- [setAttribute](XRAssets.md)
- [setId](XRAssets.md)
...
• **new XRAssets**(`_type`, `triggerEvent`)
