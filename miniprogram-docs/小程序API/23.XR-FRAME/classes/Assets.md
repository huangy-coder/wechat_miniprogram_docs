...
> 官方文档：[Class: Assets](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/Assets.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / Assets
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / Assets

资源加载组组件，会统计作为其子节点的[AssetLoad](AssetLoad.md)组件的加载状态，派发事件。
一般被代理到[XRAssets](XRAssets.md)元素。
...
- [`Component`](Component.md)<[`IAssetsData`](../interfaces/IAssetsData.md)> ↳ **`Assets`**

## Table of contents

### Constructors

- [constructor](Assets.md)
...
| `data` | [`IAssetsData`](../interfaces/IAssetsData.md) |
...
| --- | --- |
| `data` | [`IAssetsData`](../interfaces/IAssetsData.md) |
| `preData` | [`IAssetsData`](../interfaces/IAssetsData.md) |
...
▸ **getData**<`T`>(`key`): [`IAssetsData`](../interfaces/IAssetsData.md)[`T`]
...
[`IAssetsData`](../interfaces/IAssetsData.md)[`T`]
...
| Name | Type |
| --- | --- |
| `data` | `Partial`<[`IAssetsData`](../interfaces/IAssetsData.md)> |
...
| --- | --- |
| `key` | `T` |
| `value` | [`IAssetsData`](../interfaces/IAssetsData.md)[`T`] |
