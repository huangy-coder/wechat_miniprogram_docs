...
> 官方文档：[Class: XRAssetPostProcess](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRAssetPostProcess.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRAssetPostProcess
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRAssetPostProcess

标签为`xr-asset-render-texture`。

默认组件见[AssetPostProcessDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetPostProcessDefaultComponents)，属性映射见[AssetPostProcessDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetPostProcessDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRAssetPostProcess`**

## Table of contents

### Constructors

- [constructor](XRAssetPostProcess.md)

### Properties

- [dataMapping](XRAssetPostProcess.md)
- [defaultComponents](XRAssetPostProcess.md)
- [TYPE](XRAssetPostProcess.md)

### Accessors

- [event](XRAssetPostProcess.md)
- [id](XRAssetPostProcess.md)
- [inXML](XRAssetPostProcess.md)
- [name](XRAssetPostProcess.md)
- [parent](XRAssetPostProcess.md)
- [scene](XRAssetPostProcess.md)

### Methods

- [addChild](XRAssetPostProcess.md)
- [addComponent](XRAssetPostProcess.md)
- [dfs](XRAssetPostProcess.md)
- [getChildAtIndex](XRAssetPostProcess.md)
- [getChildByClass](XRAssetPostProcess.md)
- [getChildByFilter](XRAssetPostProcess.md)
- [getChildByName](XRAssetPostProcess.md)
- [getChildrenByFilter](XRAssetPostProcess.md)
- [getChildrenByName](XRAssetPostProcess.md)
- [getComponent](XRAssetPostProcess.md)
- [release](XRAssetPostProcess.md)
- [removeChild](XRAssetPostProcess.md)
- [removeComponent](XRAssetPostProcess.md)
- [setAttribute](XRAssetPostProcess.md)
- [setId](XRAssetPostProcess.md)

## Constructors

### constructor

• **new XRAssetPostProcess**(`_type`, `triggerEvent`)
