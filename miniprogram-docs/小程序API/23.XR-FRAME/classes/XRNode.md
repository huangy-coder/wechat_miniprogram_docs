...
> 官方文档：[Class: XRNode](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRNode.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRNode
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRNode

标签为`xr-node`，场景中所有3D节点的基础。

默认组件见[NodeDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#NodeDefaultComponents)，属性映射见[NodeDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#NodeDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRNode`**

## Table of contents

### Constructors

- [constructor](XRNode.md)

### Properties

- [dataMapping](XRNode.md)
- [defaultComponents](XRNode.md)
- [isXRNode](XRNode.md)
- [TYPE](XRNode.md)
...
- [addChild](XRNode.md)
- [addComponent](XRNode.md)
- [dfs](XRNode.md)
- [getChildAtIndex](XRNode.md)
- [getChildByClass](XRNode.md)
- [getChildByFilter](XRNode.md)
- [getChildByName](XRNode.md)
- [getChildrenByFilter](XRNode.md)
- [getChildrenByName](XRNode.md)
- [getComponent](XRNode.md)
- [release](XRNode.md)
- [removeChild](XRNode.md)
- [removeComponent](XRNode.md)
- [setAttribute](XRNode.md)
- [setId](XRNode.md)
- [IS](XRNode.md)
...
• `Readonly` **isXRNode**: `boolean` = `true`
...
▸ `Static` **IS**(`element`): element is XRNode
