...
> 官方文档：[Class: XRShadow](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRShadow.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRShadow
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRShadow

标签为`xr-shadow`。
是一种特殊的节点，开发者**仅可在其下以及子孙挂载自己创建的节点**！

默认组件见[ShadowDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#ShadowDefaultComponents)，属性映射见[ShadowDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#ShadowDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRShadow`** ↳↳ [`XRGLTF`](XRGLTF.md)

## Table of contents

### Constructors

- [constructor](XRShadow.md)

### Properties

- [dataMapping](XRShadow.md)
- [defaultComponents](XRShadow.md)
- [TYPE](XRShadow.md)
...
- [addChild](XRShadow.md)
- [addComponent](XRShadow.md)
- [dfs](XRShadow.md)
- [getChildAtIndex](XRShadow.md)
- [getChildByClass](XRShadow.md)
- [getChildByFilter](XRShadow.md)
- [getChildByName](XRShadow.md)
- [getChildrenByFilter](XRShadow.md)
- [getChildrenByName](XRShadow.md)
- [getComponent](XRShadow.md)
- [release](XRShadow.md)
- [removeChild](XRShadow.md)
- [removeComponent](XRShadow.md)
- [setAttribute](XRShadow.md)
- [setId](XRShadow.md)
...
• **new XRShadow**(`_type`, `triggerEvent`)
