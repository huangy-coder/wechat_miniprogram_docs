...
> 官方文档：[Class: XRARTracker](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRARTracker.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRARTracker
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRARTracker

标签为`xr-ar-tracker`。

默认组件见[ARTrackerDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#ARTrackerDefaultComponents)，属性映射见[ARTrackerDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#ARTrackerDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRARTracker`**

## Table of contents

### Constructors

- [constructor](XRARTracker.md)

### Properties

- [dataMapping](XRARTracker.md)
- [defaultComponents](XRARTracker.md)
- [TYPE](XRARTracker.md)

### Accessors

- [event](XRARTracker.md)
- [id](XRARTracker.md)
- [inXML](XRARTracker.md)
- [name](XRARTracker.md)
- [parent](XRARTracker.md)
- [scene](XRARTracker.md)

### Methods

- [addChild](XRARTracker.md)
- [addComponent](XRARTracker.md)
- [dfs](XRARTracker.md)
- [getChildAtIndex](XRARTracker.md)
- [getChildByClass](XRARTracker.md)
- [getChildByFilter](XRARTracker.md)
- [getChildByName](XRARTracker.md)
- [getChildrenByFilter](XRARTracker.md)
- [getChildrenByName](XRARTracker.md)
- [getComponent](XRARTracker.md)
- [release](XRARTracker.md)
- [removeChild](XRARTracker.md)
- [removeComponent](XRARTracker.md)
- [setAttribute](XRARTracker.md)
- [setId](XRARTracker.md)

## Constructors

### constructor

• **new XRARTracker**(`_type`, `triggerEvent`)
