...
> 官方文档：[Class: XREnv](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XREnv.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XREnv
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XREnv

标签为`xr-env`。

默认组件见[EnvDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#EnvDefaultComponents)，属性映射见[EnvDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#EnvDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XREnv`**

## Table of contents

### Constructors

- [constructor](XREnv.md)

### Properties

- [dataMapping](XREnv.md)
- [defaultComponents](XREnv.md)
- [neverTick](XREnv.md)
- [TYPE](XREnv.md)
...
- [addChild](XREnv.md)
- [addComponent](XREnv.md)
- [dfs](XREnv.md)
- [getChildAtIndex](XREnv.md)
- [getChildByClass](XREnv.md)
- [getChildByFilter](XREnv.md)
- [getChildByName](XREnv.md)
- [getChildrenByFilter](XREnv.md)
- [getChildrenByName](XREnv.md)
- [getComponent](XREnv.md)
- [release](XREnv.md)
- [removeChild](XREnv.md)
- [removeComponent](XREnv.md)
- [setAttribute](XREnv.md)
- [setId](XREnv.md)
