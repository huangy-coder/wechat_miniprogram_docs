...
> 官方文档：[Class: XRMaterial](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRMaterial.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRMaterial
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRMaterial

标签为`xr-asset-material`。

默认组件见[AssetMaterialDefaultComponents](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetMaterialDefaultComponents)，属性映射见[AssetMaterialDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetMaterialDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRMaterial`**

## Table of contents

### Constructors

- [constructor](XRMaterial.md)

### Properties

- [dataMapping](XRMaterial.md)
- [defaultComponents](XRMaterial.md)
- [TYPE](XRMaterial.md)
...
- [inXML](XRMaterial.md)
- [name](XRMaterial.md)
- [parent](XRMaterial.md)
- [scene](XRMaterial.md)

### Methods

- [addChild](XRMaterial.md)
- [addComponent](XRMaterial.md)
- [dfs](XRMaterial.md)
- [getChildAtIndex](XRMaterial.md)
- [getChildByClass](XRMaterial.md)
- [getChildByFilter](XRMaterial.md)
- [getChildByName](XRMaterial.md)
- [getChildrenByFilter](XRMaterial.md)
- [getChildrenByName](XRMaterial.md)
- [getComponent](XRMaterial.md)
- [release](XRMaterial.md)
- [removeChild](XRMaterial.md)
- [removeComponent](XRMaterial.md)
- [setAttribute](XRMaterial.md)
- [setId](XRMaterial.md)
...
• **new XRMaterial**(`_type`, `triggerEvent`)
