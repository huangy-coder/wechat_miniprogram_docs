...
> 官方文档：[Class: XRParticle](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRParticle.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRParticle
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRParticle

## Hierarchy

- [`Element`](Element.md) ↳ **`XRParticle`**

## Table of contents

### Constructors

- [constructor](XRParticle.md)

### Properties

- [dataMapping](XRParticle.md)
- [defaultComponents](XRParticle.md)
- [TYPE](XRParticle.md)
...
- [inXML](XRParticle.md)
- [name](XRParticle.md)
- [parent](XRParticle.md)
- [scene](XRParticle.md)

### Methods

- [addChild](XRParticle.md)
- [addComponent](XRParticle.md)
- [dfs](XRParticle.md)
- [getChildAtIndex](XRParticle.md)
- [getChildByClass](XRParticle.md)
- [getChildByFilter](XRParticle.md)
- [getChildByName](XRParticle.md)
- [getChildrenByFilter](XRParticle.md)
- [getChildrenByName](XRParticle.md)
- [getComponent](XRParticle.md)
- [release](XRParticle.md)
- [removeChild](XRParticle.md)
- [removeComponent](XRParticle.md)
- [setAttribute](XRParticle.md)
- [setId](XRParticle.md)
...
• **new XRParticle**(`_type`, `triggerEvent`)
