...
> 官方文档：[Class: XRAssetLoad](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/classes/XRAssetLoad.html)
> 所属分类：[XR-FRAME](../XR-FRAME目录.md)
> 导航路径：XR-FRAME / Classes / XRAssetLoad
> 整理日期：2026-06-01
> 本地化说明：正文按官方 API 页面结构转换为 Markdown，保留参数、返回值、回调、错误码、版本限制、注意事项和示例等开发信息。

[xr-frame](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/) / [Exports](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html) / XRAssetLoad

标签为`xr-asset-load`。

属性映射见[AssetLoadDataMapping](https://developers.weixin.qq.com/miniprogram/dev/api/xr-frame/modules.html#AssetLoadDataMapping)。

## Hierarchy

- [`Element`](Element.md) ↳ **`XRAssetLoad`**

## Table of contents

### Constructors

- [constructor](XRAssetLoad.md)

### Properties

- [dataMapping](XRAssetLoad.md)
- [defaultComponents](XRAssetLoad.md)
- [neverTick](XRAssetLoad.md)
- [TYPE](XRAssetLoad.md)

### Accessors

- [event](XRAssetLoad.md)
- [id](XRAssetLoad.md)
- [inXML](XRAssetLoad.md)
- [name](XRAssetLoad.md)
- [parent](XRAssetLoad.md)
- [scene](XRAssetLoad.md)

### Methods

- [addChild](XRAssetLoad.md)
- [addComponent](XRAssetLoad.md)
- [dfs](XRAssetLoad.md)
- [getChildAtIndex](XRAssetLoad.md)
- [getChildByClass](XRAssetLoad.md)
- [getChildByFilter](XRAssetLoad.md)
- [getChildByName](XRAssetLoad.md)
- [getChildrenByFilter](XRAssetLoad.md)
- [getChildrenByName](XRAssetLoad.md)
- [getComponent](XRAssetLoad.md)
- [release](XRAssetLoad.md)
- [removeChild](XRAssetLoad.md)
- [removeComponent](XRAssetLoad.md)
- [setAttribute](XRAssetLoad.md)
- [setId](XRAssetLoad.md)
