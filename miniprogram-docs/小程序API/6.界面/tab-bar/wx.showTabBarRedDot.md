...
> 官方文档：[wx.showTabBarRedDot(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/tab-bar/wx.showTabBarRedDot.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / Tab Bar / wx.showTabBarRedDot
> 整理日期：2026-06-01
