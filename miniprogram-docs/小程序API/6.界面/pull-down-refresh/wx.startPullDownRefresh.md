...
> 官方文档：[wx.startPullDownRefresh(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/pull-down-refresh/wx.startPullDownRefresh.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 下拉刷新 / wx.startPullDownRefresh
> 整理日期：2026-06-01
