...
> 官方文档：[wx.disableAlertBeforeUnload(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/interaction/wx.disableAlertBeforeUnload.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 交互 / wx.disableAlertBeforeUnload
> 整理日期：2026-06-01
...
> 相关文档: [开启监听 wx.enableAlertBeforeUnload](wx.enableAlertBeforeUnload.md)
