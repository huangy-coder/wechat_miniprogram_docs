...
> 官方文档：[wx.offUserOffTranslation(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/menu/wx.offUserOffTranslation.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 菜单 / wx.offUserOffTranslation
> 整理日期：2026-06-01
