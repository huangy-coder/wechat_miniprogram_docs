...
> 官方文档：[wx.offUserTriggerTranslation(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/menu/wx.offUserTriggerTranslation.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 菜单 / wx.offUserTriggerTranslation
> 整理日期：2026-06-01
