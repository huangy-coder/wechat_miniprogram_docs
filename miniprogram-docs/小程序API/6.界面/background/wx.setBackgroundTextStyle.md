...
> 官方文档：[wx.setBackgroundTextStyle(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/background/wx.setBackgroundTextStyle.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 背景 / wx.setBackgroundTextStyle
> 整理日期：2026-06-01
