...
> 官方文档：[wx.offParallelStateChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/ui/window/wx.offParallelStateChange.html)
> 所属分类：[界面](../界面目录.md)
> 导航路径：界面 / 窗口 / wx.offParallelStateChange
> 整理日期：2026-06-01
