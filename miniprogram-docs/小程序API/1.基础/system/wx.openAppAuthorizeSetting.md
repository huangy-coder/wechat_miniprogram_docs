...
> 官方文档：[wx.openAppAuthorizeSetting(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/base/system/wx.openAppAuthorizeSetting.html)
> 所属分类：[基础](../基础目录.md)
> 导航路径：基础 / 系统 / wx.openAppAuthorizeSetting
> 整理日期：2026-06-01
