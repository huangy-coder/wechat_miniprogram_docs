...
> 官方文档：[wx.offApiCategoryChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/base/app/life-cycle/wx.offApiCategoryChange.html)
> 所属分类：[基础](../../基础目录.md)
> 导航路径：基础 / 小程序 / 生命周期 / wx.offApiCategoryChange
> 整理日期：2026-06-01
