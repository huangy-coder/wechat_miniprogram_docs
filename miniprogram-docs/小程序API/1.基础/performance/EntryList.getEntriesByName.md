...
> 官方文档：[Array.< PerformanceEntry > EntryList.getEntriesByName(string name, string entryType)](https://developers.weixin.qq.com/miniprogram/dev/api/base/performance/EntryList.getEntriesByName.html)
> 所属分类：[基础](../基础目录.md)
> 导航路径：基础 / 性能 / EntryList / EntryList.getEntriesByName
> 整理日期：2026-06-01
