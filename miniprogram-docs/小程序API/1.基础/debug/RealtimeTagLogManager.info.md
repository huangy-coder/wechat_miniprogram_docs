...
> 官方文档：[RealtimeTagLogManager.info(string key, Object|Array.<any>|number|string value)](https://developers.weixin.qq.com/miniprogram/dev/api/base/debug/RealtimeTagLogManager.info.html)
> 所属分类：[基础](../基础目录.md)
> 导航路径：基础 / 调试 / RealtimeTagLogManager / RealtimeTagLogManager.info
> 整理日期：2026-06-01
