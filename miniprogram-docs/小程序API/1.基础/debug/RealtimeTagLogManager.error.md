...
> 官方文档：[RealtimeTagLogManager.error(string key, Object|Array.<any>|number|string value)](https://developers.weixin.qq.com/miniprogram/dev/api/base/debug/RealtimeTagLogManager.error.html)
> 所属分类：[基础](../基础目录.md)
> 导航路径：基础 / 调试 / RealtimeTagLogManager / RealtimeTagLogManager.error
> 整理日期：2026-06-01
