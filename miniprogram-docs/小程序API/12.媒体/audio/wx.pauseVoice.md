...
> 官方文档：[wx.pauseVoice(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/media/audio/wx.pauseVoice.html)
> 所属分类：[媒体](../媒体目录.md)
> 导航路径：媒体 / 音频 / wx.pauseVoice
> 整理日期：2026-06-01
...
暂停正在播放的语音。再次调用 [wx.playVoice](wx.playVoice.md) 播放同一个文件时，会从暂停处开始播放。如果想从头开始播放，需要先调用 [wx.stopVoice](wx.stopVoice.md)。
