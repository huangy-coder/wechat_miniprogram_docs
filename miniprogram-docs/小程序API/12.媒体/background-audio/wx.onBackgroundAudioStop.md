...
> 官方文档：[wx.onBackgroundAudioStop(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/media/background-audio/wx.onBackgroundAudioStop.html)
> 所属分类：[媒体](../媒体目录.md)
> 导航路径：媒体 / 背景音频 / wx.onBackgroundAudioStop
> 整理日期：2026-06-01
