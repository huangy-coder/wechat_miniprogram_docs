...
> 官方文档：[Promise VideoDecoder.seek(number position)](https://developers.weixin.qq.com/miniprogram/dev/api/media/video-decoder/VideoDecoder.seek.html)
> 所属分类：[媒体](../媒体目录.md)
> 导航路径：媒体 / 视频解码器 / VideoDecoder / VideoDecoder.seek
> 整理日期：2026-06-01
