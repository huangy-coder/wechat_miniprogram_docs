...
> 官方文档：[wx.chooseInvoice(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/invoice/wx.chooseInvoice.html)
> 所属分类：[开放接口](../开放接口目录.md)
> 导航路径：开放接口 / 发票 / wx.chooseInvoice
> 整理日期：2026-06-01
...
其中 `access_token` 的获取请参考[auth.getAccessToken](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/invoice/(auth.getAccessToken))文档
