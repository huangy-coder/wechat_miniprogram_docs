...
> 官方文档：[wx.openSingleStickerView(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/sticker/wx.openSingleStickerView.html)
> 所属分类：[开放接口](../开放接口目录.md)
> 导航路径：开放接口 / 微信表情 / wx.openSingleStickerView
> 整理日期：2026-06-01
