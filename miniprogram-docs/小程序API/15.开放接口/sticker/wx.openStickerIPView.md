...
> 官方文档：[wx.openStickerIPView(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/sticker/wx.openStickerIPView.html)
> 所属分类：[开放接口](../开放接口目录.md)
> 导航路径：开放接口 / 微信表情 / wx.openStickerIPView
> 整理日期：2026-06-01
