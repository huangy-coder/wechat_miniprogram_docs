...
> 官方文档：[wx.chooseLicensePlate(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/license-plate/wx.chooseLicensePlate.html)
> 所属分类：[开放接口](../开放接口目录.md)
> 导航路径：开放接口 / 车牌 / wx.chooseLicensePlate
> 整理日期：2026-06-01
