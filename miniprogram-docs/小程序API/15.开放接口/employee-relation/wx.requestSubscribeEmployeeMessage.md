...
> 官方文档：[wx.requestSubscribeEmployeeMessage(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/open-api/employee-relation/wx.requestSubscribeEmployeeMessage.html)
> 所属分类：[开放接口](../开放接口目录.md)
> 导航路径：开放接口 / 用工关系 / wx.requestSubscribeEmployeeMessage
> 整理日期：2026-06-01
