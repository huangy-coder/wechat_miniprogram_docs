...
> 官方文档：[wx.removeSecureElementPass(Object args)](https://developers.weixin.qq.com/miniprogram/dev/api/device/nfc/wx.removeSecureElementPass.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / NFC 读写 / wx.removeSecureElementPass
> 整理日期：2026-06-01
