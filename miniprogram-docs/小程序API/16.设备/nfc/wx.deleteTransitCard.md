...
> 官方文档：[wx.deleteTransitCard(Object args)](https://developers.weixin.qq.com/miniprogram/dev/api/device/nfc/wx.deleteTransitCard.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / NFC 读写 / wx.deleteTransitCard
> 整理日期：2026-06-01
...
```javascript
const { errMsg, errno, errorCode } = await wx.deleteTransitCard({
  issuerID: 'changsha',
  orderNo: 'order_xxx',
  sign: 'sign_xxx',
