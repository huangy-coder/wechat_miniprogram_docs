...
> 官方文档：[wx.offUserCaptureScreen()](https://developers.weixin.qq.com/miniprogram/dev/api/device/screen/wx.offUserCaptureScreen.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 屏幕 / wx.offUserCaptureScreen
> 整理日期：2026-06-01
