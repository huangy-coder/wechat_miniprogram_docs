...
> 官方文档：[wx.offCompassChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/device/compass/wx.offCompassChange.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 罗盘 / wx.offCompassChange
> 整理日期：2026-06-01
