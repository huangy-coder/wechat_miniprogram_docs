...
> 官方文档：[wx.getSelectedTextRange(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/keyboard/wx.getSelectedTextRange.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 键盘 / wx.getSelectedTextRange
> 整理日期：2026-06-01
