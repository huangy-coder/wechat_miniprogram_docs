...
> 官方文档：[wx.offKeyboardHeightChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/device/keyboard/wx.offKeyboardHeightChange.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 键盘 / wx.offKeyboardHeightChange
> 整理日期：2026-06-01
