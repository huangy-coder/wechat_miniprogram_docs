...
> 官方文档：[wx.getHCEState(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/nfc-hce/wx.getHCEState.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / NFC 主机卡模拟 / wx.getHCEState
> 整理日期：2026-06-01
