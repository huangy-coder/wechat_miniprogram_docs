...
> 官方文档：[wx.offHCEMessage(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/device/nfc-hce/wx.offHCEMessage.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / NFC 主机卡模拟 / wx.offHCEMessage
> 整理日期：2026-06-01
