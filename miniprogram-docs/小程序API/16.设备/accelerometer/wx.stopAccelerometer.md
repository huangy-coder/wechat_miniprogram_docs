...
> 官方文档：[wx.stopAccelerometer(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/accelerometer/wx.stopAccelerometer.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 加速计 / wx.stopAccelerometer
> 整理日期：2026-06-01
