...
> 官方文档：[wx.startAccelerometer(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/accelerometer/wx.startAccelerometer.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 加速计 / wx.startAccelerometer
> 整理日期：2026-06-01
...
| --- | --- | --- | --- | --- | --- |
| interval | string | normal | 否 | 监听加速度数据回调函数的执行频率 | [2.1.0](https://developers.weixin.qq.com/miniprogram/dev/framework/compatibility.html) |
