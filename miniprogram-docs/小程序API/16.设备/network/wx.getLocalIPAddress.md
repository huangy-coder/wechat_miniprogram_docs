...
> 官方文档：[wx.getLocalIPAddress(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/network/wx.getLocalIPAddress.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 网络 / wx.getLocalIPAddress
> 整理日期：2026-06-01
