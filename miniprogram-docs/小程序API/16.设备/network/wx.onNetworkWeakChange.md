...
> 官方文档：[wx.onNetworkWeakChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/device/network/wx.onNetworkWeakChange.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 网络 / wx.onNetworkWeakChange
> 整理日期：2026-06-01
