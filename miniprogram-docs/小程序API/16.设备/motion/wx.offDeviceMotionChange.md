...
> 官方文档：[wx.offDeviceMotionChange(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/device/motion/wx.offDeviceMotionChange.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 设备方向 / wx.offDeviceMotionChange
> 整理日期：2026-06-01
