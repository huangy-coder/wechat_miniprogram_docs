...
> 官方文档：[wx.stopDeviceMotionListening(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/motion/wx.stopDeviceMotionListening.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 设备方向 / wx.stopDeviceMotionListening
> 整理日期：2026-06-01
