...
> 官方文档：[wx.setClipboardData(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/clipboard/wx.setClipboardData.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 剪贴板 / wx.setClipboardData
> 整理日期：2026-06-01
