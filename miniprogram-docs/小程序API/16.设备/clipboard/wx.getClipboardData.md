...
> 官方文档：[wx.getClipboardData(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/clipboard/wx.getClipboardData.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 剪贴板 / wx.getClipboardData
> 整理日期：2026-06-01
