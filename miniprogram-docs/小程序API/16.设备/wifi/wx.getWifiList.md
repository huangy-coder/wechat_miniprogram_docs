...
> 官方文档：[wx.getWifiList(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/wifi/wx.getWifiList.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / Wi-Fi / wx.getWifiList
> 整理日期：2026-06-01
...
请求获取 Wi-Fi 列表。`wifiList` 数据会在 [onGetWifiList](wx.onGetWifiList.md) 注册的回调中返回。 **Android 调用前需要 [用户授权](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/authorize.html) scope.userLocation。**
