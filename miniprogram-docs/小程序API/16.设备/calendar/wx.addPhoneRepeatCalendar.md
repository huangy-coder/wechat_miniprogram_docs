...
> 官方文档：[wx.addPhoneRepeatCalendar(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/device/calendar/wx.addPhoneRepeatCalendar.html)
> 所属分类：[设备](../设备目录.md)
> 导航路径：设备 / 日历 / wx.addPhoneRepeatCalendar
> 整理日期：2026-06-01
