...
> 官方文档：[wx.offLocationChangeError(function listener)](https://developers.weixin.qq.com/miniprogram/dev/api/location/wx.offLocationChangeError.html)
> 所属分类：[位置](位置目录.md)
> 导航路径：位置 / wx.offLocationChangeError
> 整理日期：2026-06-01
