...
> 官方文档：[wx.stopLocationUpdate(Object object)](https://developers.weixin.qq.com/miniprogram/dev/api/location/wx.stopLocationUpdate.html)
> 所属分类：[位置](位置目录.md)
> 导航路径：位置 / wx.stopLocationUpdate
> 整理日期：2026-06-01
